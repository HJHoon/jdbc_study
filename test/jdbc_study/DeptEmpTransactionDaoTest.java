...
public class DeptEmpTransactionDaoTest {
	...
	public void test1DepartmentFail() {
		...
		Employee emp = new Employee(1004, "채지안", "사원", new Employee(1003), 1500000, dept);
	...
	public void test2EmployeeFail() {
		...
		Employee emp = new Employee(1003, "이민정", "과장", new Employee(4377), 3000000, dept);
	...
	public void test3() throws SQLException {
		...
		Department dept = new Department(6, "마케팅", 10);
		Employee emp = new Employee(1236, "김태희", "사원", new Employee(1003), 1500000, dept);
